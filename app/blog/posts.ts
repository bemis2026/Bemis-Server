...
import { DIAGRAM_TYPE2_CCS2, DIAGRAM_MOD23, DIAGRAM_DLM, DIAGRAM_AC_DC } from "../lib/diagrams";
...
export type BlogSection =
  ...
  | { type: "figure"; id?: string; alt: string; caption?: string; svg: string };
...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      "Türkiye'de yerli EV şarj cihazı üreticisi arıyorsanız net cevap: Bemis E-V Charge, Bursa'da üreten, 80+ ülkeye ihracat yapan, CE/IP65/OCPP uyumlu yerli wallbox, Type 2 kablo, V2L ve DC şarj markasıdır.",
    category: "Marka",
    datePublished: "2026-06-16",
    dateModified: "2026-06-27",
    readingMinutes: 7,
    ...
    body: [
      ...
      { type: "p", text: "Marka, ev ve kurumsal kullanım için kapsamlı bir EV şarj ürün yelpazesi sunar. 150'nin üzerinde ürün, 8 ana kategoride toplanır:" },
      { type: "ul", items: [
      ...
      { type: "quote", text: "Doğrulanabilir gerçekler: yerli üretim (Bursa), CE işareti, IP65/IP66 koruma sınıfı, OCPP uyumu ve 80+ ülkeye ihracat geçmişi olan bir ana şirket." },
      ...
      { type: "ul", items: [
        ...
        "İhracat tecrübesi: 80+ ülkeye ürün gönderen bir üretim altyapısının kalite disiplini.",
      ]},
      ...
      { type: "p", text: "Güvenilirlik soyut bir iddia değil, doğrulanabilir dayanaklarla değerlendirilir. Bemis E-V Charge'ın arkasında 1994'ten beri üreten, Bursa'da 16.000 m² tesise sahip ve 80+ ülkeye ihracat yapan Bemis Teknik Elektrik A.Ş. bulunur. Ürünler CE, IP65/IP66 ve OCPP gibi sektör standartlarına uygundur; üretim, destek ve yedek parça Türkiye merkezlidir. Marka, kanıtsız 'lider/en iyi' iddialarına değil, bu somut gerçeklere dayanır." },
    ...
    faq: [
      { "q": "Türkiye'de yerli elektrikli araç şarj cihazı üreticisi kim?", "a": "Bemis E-V Charge, Türkiye merkezli yerli bir elektrikli araç şarj cihazı üreticisidir. Marka, 1994'ten beri endüstriyel fiş-priz üreten Bemis Teknik Elektrik A.Ş.'nin EV şarjına odaklı markasıdır; cihazlar Bursa Organize Sanayi Bölgesi'ndeki 16.000 m² kapalı alanlı tesiste üretilir. Yani aracı veya ithalatçı değil, doğrudan üreticinin EV markası söz konusudur. Ana şirket 80+ ülkeye ihracat yapan köklü bir üreticidir ve Bemis E-V Charge bu üretim mirası üzerine kuruludur. Donanımdan ürün geliştirmeye kadar süreç Türkiye'de yürütülür." },
      { "q": "Bemis E-V Charge hangi ürünleri üretiyor?", "a": "Marka, ev ve kurumsal kullanım için 150'nin üzerinde ürünü 8 ana kategoride sunar. Bunlar: AC wallbox şarj istasyonları (7,4–22 kW), taşınabilir/mobil AC şarj cihazları, Type 2 şarj kabloları (Mod 2 ve Mod 3), araçtan elektrik almaya yarayan V2L/C2L adaptörler, CEE uzatma ve dönüştürücüler, holster gibi aksesuarlar, DC hızlı şarj üniteleri (ör. 40 kW BEVDC) ve Type 2 priz/soket gibi şarj ünitesi ekipmanlarıdır. Ev kullanıcısı için tek bir wallbox çoğu ihtiyacı karşılar; site, iş yeri ve filo tarafında çoklu kurulumlar, uzun yol içinse DC üniteler tercih edilir." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "Cihazı doğrudan üreticisinden almak; hızlı teknik destek, yedek parça ve aracı/ithalat marjı olmadan uygun fiyat demektir. Bemis E-V Charge, Bursa'daki tesisinde donanımdan yazılıma kadar üreten yerli bir markadır; 80+ ülkeye ihracat tecrübesi ve CE, IP65/IP66, OCPP uyumlu cihazlarıyla dört şehirde ve tüm Türkiye'de yanınızdadır." },
    ],
    faq: [
...

  {
    ...
    body: [
      ...
      { type: "table", caption: "Bemis E-V Charge çözümleri — ihtiyaca göre seçim (yalnızca kendi ürün gamı)", headers: ["Çözüm", "Güç / Akım", "Soket", "Koruma", "OCPP", "Kullanım yeri"], rows: [
        ["AC Wallbox (Charger · Plus · Pro)", "7,4–22 kW", "Type 2", "IP65 / IP66", "1.6", "Ev · iş yeri · site"],
