...
export const metadata: Metadata = {
  ...
  title: "İletişim",
  description:
    "Bemis E-V Charge iletişim: Yeşil Cad. No:19, 16220 Nilüfer/Bursa. Tel +90 224 433 02 16, e-posta sales@bemis.com.tr. Ürün, bayilik ve teklif talepleri için ulaşın.",
  ...
  openGraph: {
    ...
    description:
      "Bemis E-V Charge iletişim: Yeşil Cad. No:19, 16220 Nilüfer/Bursa · +90 224 433 02 16 · sales@bemis.com.tr.",
    type: "website",
    url: URL_PATH,
...
const localBusiness: JsonLdObject = {
  ...
  address: {
    "@type": "PostalAddress",
    streetAddress: "Minareliçavuş Mah., Bursa OSB, Yeşil Cad. No:19",
