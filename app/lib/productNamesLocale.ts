...
const DE: Record<string, string> = {
  ...
  "DC Şarj Kablosu / Soketi CCS2 (Bir Ucu Açık)": "DC-Ladekabel / -steckdose CCS2 (offenes Ende)",
...
const ES: Record<string, string> = {
  ...
  "DC Şarj Kablosu / Soketi CCS2 (Bir Ucu Açık)": "Cable / toma de carga DC CCS2 (extremo abierto)",
...
const RU: Record<string, string> = {
  ...
  "DC Şarj Kablosu / Soketi CCS2 (Bir Ucu Açık)": "Зарядный кабель / разъём DC CCS2 (свободный конец)",
...
const NL: Record<string, string> = {
  ...
  "DC Şarj Kablosu / Soketi CCS2 (Bir Ucu Açık)": "DC-laadkabel / -connector CCS2 (open einde)",
...
const AR: Record<string, string> = {
  ...
  "DC Şarj Kablosu / Soketi CCS2 (Bir Ucu Açık)": "كابل ومقبس شحن DC بمعيار CCS2 (مفتوح الطرف)",
};
