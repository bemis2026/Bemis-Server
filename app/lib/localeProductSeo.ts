...
// 40–200 kW · IP65 · OCPP · CE · 1994 · 80+ ülke = sitede zaten yazılı olgular).
...
export const LOCALE_CATEGORY_SEO: Record<LocaleLang, Record<string, CatSeo>> = {
  de: {
    ...
    "converters": { name: "Verlängerungskabel & Adapter", title: "Hersteller von Ladeverlängerungen und CEE-Adaptern", description: "Verlängerungskabel und CEE-Adapter/-Konverter für die Ladeinfrastruktur, Type-2-kompatibel. CE. Hergestellt in der Türkei, Export in 80+ Länder." },
  ...
  es: {
    ...
    "converters": { name: "Alargadores y adaptadores", title: "Fabricante de alargadores de carga y adaptadores CEE", description: "Cables alargadores y adaptadores/convertidores CEE para la carga, compatibles con Type 2. CE. Fabricado en Türkiye, exportación a más de 80 países." },
  ...
  ru: {
    ...
    "converters": { name: "Удлинители и адаптеры", title: "Производитель удлинителей и CEE-адаптеров для зарядки", description: "Удлинители и CEE-адаптеры/переходники для зарядной инфраструктуры, совместимые с Type 2. CE. Производство в Турции, экспорт в 80+ стран." },
  ...
  nl: {
    ...
    "converters": { name: "Verlengkabels & adapters", title: "Fabrikant van laadverlengkabels en CEE-adapters", description: "Verlengkabels en CEE-adapters/verloopstukken voor laadinfrastructuur, Type 2-compatibel. CE. Geproduceerd in Türkiye, export naar 80+ landen." },
