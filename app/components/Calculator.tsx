  ...
  return (
    <div className="mb-3">
      <div className="flex justify-between items-center mb-1.5">
        <span className="text-[11px] font-medium" style={{ color: textMuted }}>{label}</span>
        <span className="text-xs font-bold tabular-nums" style={{ color: accent }}>{displayValue}</span>
      </div>
      <input type="range" min={min} max={max} step={step} value={value}
        onChange={(e) => onChange(Number(e.target.value))}
        className="calc-slider w-full" style={sliderStyle(value, min, max, accent)} />
      <div className="flex justify-between mt-1">
        <span className="text-[9px]" style={{ color: textMuted }}>{min.toLocaleString("tr-TR")}{unit}</span>
        <span className="text-[9px]" style={{ color: textMuted }}>{max.toLocaleString("tr-TR")}{unit}</span>
      </div>
    </div>
  );
}
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-4">
          ...
          >
            ...
            <span className="text-[9px] tracking-widest uppercase font-semibold" style={{ color: d ? `${BLUE}80` : `${BLUE}99` }}>
              Şarj Simülasyonu
            </span>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-xs" style={{ color: textMuted }}
          >
              ...
              {activeTab === "charge" ? (
                ...
                >
                  <div className="p-3 sm:p-4">
                    ...
                    {/* Car selector */}
                    <div className="mb-4">
                      <label className="text-[11px] font-bold uppercase tracking-wider mb-1.5 flex items-center gap-1.5" style={{ color: textMuted }}>
                      ...
                      {selectedCarData && (
                        <div className="flex flex-wrap gap-1.5 mt-2">
                          <span className="text-[10px] px-2 py-0.5 rounded-full" style={{ background: `${BLUE}15`, color: BLUE, border: `1px solid ${BLUE}25` }}>Batarya: {selectedCarData.battery} kWh</span>
                          <span className="text-[10px] px-2 py-0.5 rounded-full" style={{ background: `${GREEN}15`, color: GREEN, border: `1px solid ${GREEN}25` }}>AC maks: {selectedCarData.maxAcKw} kW</span>
                          <span className="text-[10px] px-2 py-0.5 rounded-full" style={{ background: `${ORANGE}15`, color: ORANGE, border: `1px solid ${ORANGE}25` }}>DC maks: {selectedCarData.maxDcKw} kW</span>
                        </div>
                      )}
                    </div>
                    ...
                    {selectedCarData ? (
                      <div className="mb-3">
                        <div className="flex justify-between items-center mb-1.5">
                          <span className="text-[11px] font-medium" style={{ color: textMuted }}>Batarya Kapasitesi</span>
                        </div>
                        <div className="rounded-xl px-3 py-2.5 flex items-center justify-between"
                          ...
                          <span className="text-[10px] font-medium" style={{ color: textMuted }}>🔒 araç verisi</span>
                        </div>
                      </div>
                    ) : (
                    ...
                    <AnimatePresence mode="wait">
                      <motion.div key={chargeMode} initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -6 }} transition={{ duration: 0.15 }}>
                        <p className="text-[11px] font-medium mb-2" style={{ color: textMuted }}>
                ...
                >
                  <div className="p-4 sm:p-5">
                    <p className="text-xs font-bold uppercase tracking-wider mb-4" style={{ color: textMuted }}>Kullanım Bilgileri</p>
              ...
              {activeTab === "charge" ? (
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-2 px-4 pb-3">
                    {[
                      ...
                      <div key={i} className="rounded-xl py-2 px-1.5 text-center"
                        ...
                        <p className="text-[9px] mb-0.5" style={{ color: d ? "rgba(255,255,255,0.35)" : "rgba(0,0,0,0.38)" }}>{stat.label}</p>
                        <p className="text-[11px] font-black" style={{ color: stat.color }}>{stat.value}</p>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="mx-4 mb-3 rounded-xl px-3.5 py-2.5 flex items-center justify-between"
                    ...
                    <div>
                      <p className="text-[9px] font-bold uppercase tracking-wider" style={{ color: GREEN }}>Elektrik Maliyeti</p>
                      <p className="text-[9px] mt-0.5" style={{ color: d ? "rgba(255,255,255,0.35)" : "rgba(0,0,0,0.38)" }}>
                  ...
                  <div className="mx-4 mb-4">
                    <p className="text-[9px] font-bold uppercase tracking-wider mb-1.5" style={{ color: d ? "rgba(255,255,255,0.28)" : "rgba(0,0,0,0.30)" }}>
                      Elektrik Tarifesi
                    </p>
                    <div className="grid grid-cols-2 gap-1 mb-2.5">
                      {TARIFF_PRESETS.map((t) => {
                        ...
                        return (
                          ...
                          >
                            <span className="text-[9px] font-bold block leading-tight" style={{ color: isActive ? GREEN : d ? "rgba(255,255,255,0.55)" : "rgba(0,0,0,0.55)" }}>{t.label}</span>
                            <span className="text-[9px] block leading-tight mt-0.5" style={{ color: isActive ? GREEN : d ? "rgba(255,255,255,0.22)" : "rgba(0,0,0,0.25)" }}>{t.desc}</span>
                          </button>
                        );
                      })}
                    </div>
                    ...
                    <div className="flex justify-between mt-1">
                      <span className="text-[9px]" style={{ color: d ? "rgba(255,255,255,0.25)" : "rgba(0,0,0,0.28)" }}>1 ₺/kWh</span>
                      <span className="text-[9px]" style={{ color: d ? "rgba(255,255,255,0.25)" : "rgba(0,0,0,0.28)" }}>20 ₺/kWh</span>
                    </div>
                  </div>

                  {/* Warnings */}
                  {selectedCarData && chargeMode === "dc" && dcPower > selectedCarData.maxDcKw && (
                    <p className="text-[10px] pb-4 text-center" style={{ color: ORANGE }}>⚡ {selectedCarData.maxDcKw} kW&apos;e kısıtlandı</p>
                  )}
                  {selectedCarData && chargeMode === "ac" && chargerPower > selectedCarData.maxAcKw && (
                    <p className="text-[10px] pb-4 text-center" style={{ color: BLUE }}>Araç {selectedCarData.maxAcKw} kW&apos;e kısıtlandı</p>
                  )}
                </motion.div>
              ) : (
                /* Savings visual */
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-3 px-5 pb-5">
                    {[
                      ...
                      <div key={i} className="rounded-xl py-3 px-3 text-center"
                        style={{ background: d ? "rgba(255,255,255,0.05)" : "rgba(0,0,0,0.05)", border: d ? "1px solid rgba(255,255,255,0.08)" : "1px solid rgba(0,0,0,0.07)" }}>
                        <p className="text-[10px] mb-1" style={{ color: d ? "rgba(255,255,255,0.35)" : "rgba(0,0,0,0.38)" }}>{item.label}</p>
                  ...
                  <div className="mx-5 mb-5 rounded-xl grid grid-cols-2 overflow-hidden"
                    ...
                    <div className="px-4 py-3.5 text-center" style={{ borderRight: `1px solid ${d ? "rgba(255,255,255,0.08)" : "rgba(0,0,0,0.08)"}`, background: d ? "rgba(255,255,255,0.03)" : "rgba(255,255,255,0.7)" }}>
                      <p className="text-[10px] uppercase tracking-wide mb-1" style={{ color: d ? "rgba(255,255,255,0.38)" : "rgba(0,0,0,0.40)" }}>EV / yıl</p>
                    ...
                    <div className="px-4 py-3.5 text-center" style={{ background: d ? "rgba(255,255,255,0.03)" : "rgba(255,255,255,0.7)" }}>
                      <p className="text-[10px] uppercase tracking-wide mb-1" style={{ color: d ? "rgba(255,255,255,0.38)" : "rgba(0,0,0,0.40)" }}>Yakıt / yıl</p>
        ...
        <motion.p initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ duration: 0.5, delay: 0.5 }}
          className="text-center text-[11px] mt-6" style={{ color: textMuted }}>
