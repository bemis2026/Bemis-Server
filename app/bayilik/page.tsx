    ...
    <div style={{ background: bg, display: "flex", flexDirection: "column", minHeight: "100vh", position: "relative", overflow: "hidden", isolation: "isolate" }}>
      ...
      <JsonLd data={[
        serviceSchema({
          ...
          description: "Türkiye'de bayi, yurt dışında distribütör programı. 80+ ilde Bemis Grup bayi ağı, 80+ ülkede ihracat tecrübesi. Teknik eğitim, pazarlama desteği ve özel bayi fiyatları.",
          url: "/bayilik",
        ...
        <div className="max-w-7xl 2xl:max-w-[1600px] mx-auto px-5 sm:px-8">
          <div className="mb-7">
            ...
            <p className="text-sm sm:text-base leading-relaxed max-w-3xl" style={{ color: muted }}>
              ...
              Bemis Grup bayi ağı 80+ ilde, distribütör ağımız ise 80+ ülkede aktiftir. Kurulum, satış sonrası
