...
type Tab = "hero" | "stats" | "products" | "contact" | "dealers" | "sections" | "media";
                ...
                <div className="max-w-xl space-y-5">
                  ...
                  {content.social && (
                    <div className="bg-white/3 border border-white/7 rounded-2xl p-5 space-y-4">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0">
                          <span className="text-[10px] font-bold text-white/40">𝕏</span>
                        </div>
                        <input value={content.social?.twitter ?? ""} onChange={(e) => updateContent(["social", "twitter"], e.target.value)}
                ...
                <div className="max-w-2xl space-y-6">
                  <div>
                    ...
                    <p className="text-xs text-white/35">
                      Görsel yükleyin (JPG, PNG, WebP, SVG). Yüklenen görseller <code className="text-white/50">/public/uploads/</code> klasörüne kaydedilir.
                    </p>
                  </div>
