    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          ...
          p: [
            "Kişisel verilerin işlenmesine ilişkin ayrıntılar için Gizlilik ve Kişisel Verilerin Korunması Aydınlatma Metni'ne bakabilirsiniz. Sorularınız için: sales@bemis.com.tr",
          ],
        },
      ]}
    />
