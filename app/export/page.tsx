...
export const metadata: Metadata = {
  ...
  description:
    "Manufacturer of Type 2 / Mode 3 EV charging cables, AC wallboxes and DC chargers in Türkiye. CE, IP65/IP66, OCPP. OEM/ODM, export to 80+ countries.",
  keywords: [
  ...
  alternates: {
    canonical: URL_PATH,
    // EN sayfası: tr→anasayfa (TR sürüm), en→kendisi, x-default→TR anasayfa (varsayılan).
    // NOT: Anasayfa "use client" olduğu için karşılıklı en→/export etiketini şu an
    // veremiyor (root'a eklemek 8 sayfayı kirletir); tam resiprokal küme anasayfa
    // server-wrapper refactor'u ister. Bu taraf yine de doğru + güvenli.
    languages: { tr: "/", en: URL_PATH, "x-default": "/" },
  },
  openGraph: {
    title: "EV Charging Cable & Charger Manufacturer — Bemis E-V Charge (Türkiye)",
    description:
      "Real EU-adjacent manufacturer since 1994. Type 2 / Mode 3 cables, AC wallboxes, DC chargers. CE, IP65/IP66, OCPP. OEM/ODM, export to 80+ countries.",
    type: "website",
    url: URL_PATH,
    locale: "en_US",
...
export default function ExportPage() {
  const jsonLd = [
    ...
    serviceSchema({
      ...
      description:
        "Manufacturer of Type 2 / Mode 3 EV charging cables, AC wallboxes (7.4–22 kW), DC fast chargers and V2L/C2L adapters. CE, IP65/IP66, OCPP-ready. OEM / ODM / private label and wholesale export from Türkiye to 80+ countries.",
      url: URL_PATH,
