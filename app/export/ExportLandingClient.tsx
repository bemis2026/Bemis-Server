  ...
  return (
    <div style={{ background: bg, minHeight: "100vh" }}>
      ...
      <section id="quote" className="py-12 px-5 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto wide-content rounded-3xl p-6 sm:p-10" style={{ background: d ? "rgba(59,130,246,0.07)" : "rgba(59,130,246,0.05)", border: `1px solid ${border}` }}>
