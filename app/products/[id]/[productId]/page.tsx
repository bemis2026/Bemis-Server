...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical, languages: { tr: canonical, en: `/en${canonical}`, de: `/de${canonical}`, es: `/es${canonical}`, ru: `/ru${canonical}`, nl: `/nl${canonical}`, ar: `/ar${canonical}`, "x-default": canonical } },
    openGraph: {
      title,
      description,
      type: "website",
